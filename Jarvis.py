...
try:
    ...
    while True:
        try:
            ...
            if 'exit' in inp:
                with open("Communication_Files/Goodbyes/main.txt") as file:
                    text = file.read()
                    AllText = list(map(str, text.splitlines()))
                words = random.choice(AllText)
                print(words)
                time.sleep(0.4)
                sys.exit()
    ...
    print("Process Interrupted! Program stopped!")
    with open("Communication_Files/Goodbyes/main.txt") as file:
        text = file.read()
        split_text = list(map(str, text.splitlines()))
    response = random.choice(split_text)
    print(response)
